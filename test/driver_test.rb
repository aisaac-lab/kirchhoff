...
class SmartDriverTest < Minitest::Test
  def test_main
    ...
    assert_nil driver.find_text("no")

    assert_nil driver.find("div#noexist", wait: false)
    assert_nil driver.find_text("no", wait: false)

    assert_raises Selenium::WebDriver::Error::NoSuchElementError do
      driver.find("div#noexist", maybe: false)
    end
    assert_raises Selenium::WebDriver::Error::NoSuchElementError do
      driver.find_text("no", maybe: false)
    end

    assert_raises Selenium::WebDriver::Error::NoSuchElementError do
      driver.find("div#noexist", wait: false, maybe: false)
    end

    assert_raises Selenium::WebDriver::Error::NoSuchElementError do
      driver.find_text("no", wait: false, maybe: false)
    end


    assert_instance_of Selenium::WebDriver::Element, driver.find("div#exist")
    assert_instance_of Selenium::WebDriver::Element, driver.find_text("Hello")

    assert_instance_of Selenium::WebDriver::Element, driver.find("div#exist", wait: false)
    assert_instance_of Selenium::WebDriver::Element, driver.find_text("Hello", wait: false)

    assert_instance_of Selenium::WebDriver::Element, driver.find("div#exist", maybe: false)
    assert_instance_of Selenium::WebDriver::Element, driver.find_text("Hello", maybe: false)
  ...
  #     begin
  #       6.times do
  #         @driver.find("button._ifrvy", wait: true).click()
  #       end
  #     rescue
  #     end
